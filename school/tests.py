...
class LessonAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create_user(
            email="testuser@mail.ru", username="TestUser", password="12345"
        )
        self.course = Course.objects.create(
            title="Тестовый курс", content="Курс для тестирования"
        )
...
class SubscriptionTestCase(APITestCase):
    def setUp(self):
        ...
        self.other_user = CustomUser.objects.create_user(
            email="testuser2@mail.ru", username="TestUser2", password="12345"
        )
        self.course = Course.objects.create(
            title="Тестовый курс", content="Курс для тестирования"
        )
        ...
        self.course_id = {"course_id": self.course.id}
